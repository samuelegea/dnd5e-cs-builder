...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference("Race.count") do
      post races_url, params: { race: { description: @race.description, name: @race.name, size: @race.size, speed: @race.speed } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { description: @race.description, name: @race.name, size: @race.size, speed: @race.speed } }
